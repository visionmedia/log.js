...
function colouredLayout (loggingEvent) {
    ...
    //console.log('HEYA: loggingEvent: '+util.inspect(loggingEvent));
    //console.log('HEYA: typeof loggingEvent.level: '+typeof loggingEvent.level);
    return timestampLevelAndCategory(loggingEvent, colours[loggingEvent.level.toUpperCase()]) + formatLogData(loggingEvent.data);
}
