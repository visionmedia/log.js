...
var Log = exports = module.exports = function Log(level, stream, console){
  if ('string' == typeof level) level = exports[level.toUpperCase()];
  this.level = level || exports.DEBUG;
  this.stream = stream || process.stdout;
  this.console = (console === true ? process.stdout : false);
...
Log.prototype = {
  ...
  log: function(levelStr, args) {
    if (exports[levelStr] <= this.level) {
      ...
      var msgWithHeader = '[' + new Date + ']'
        + ' ' + levelStr
        + ' ' + msg
        + '\n';
      if (this.console) {
          var consoleMsg = msgWithHeader[lvlColors[levelStr]];
          if (lvlEffects[levelStr]) consoleMsg = consoleMsg[lvlEffects[levelStr]];
